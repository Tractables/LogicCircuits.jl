...
#     @test varsubset(mgr[1], mgr[end])
#     @test varsubset(mgr[end].left, mgr[end])
#     @test varsubset(mgr[end].right, mgr[end])
#     @test varsubset_left(mgr[end].left, mgr[end])
#     @test varsubset_left(mgr[end].left.left, mgr[end])
#     @test varsubset_left(mgr[end].left.right, mgr[end])
#     @test varsubset_right(mgr[end].right, mgr[end])
#     @test varsubset_right(mgr[end].right.right, mgr[end])
#     @test varsubset_right(mgr[end].right.left, mgr[end])

#     @test !varsubset(mgr[end], mgr[1])
#     @test !varsubset_left(mgr[end].right, mgr[end])
#     @test !varsubset_left(mgr[end].right.left, mgr[end])
#     @test !varsubset_left(mgr[end].right.right, mgr[end])
#     @test !varsubset_left(mgr[end], mgr[end])
#     @test !varsubset_left(mgr[end], mgr[end].left)
#     @test !varsubset_left(mgr[end], mgr[end].right)
#     @test !varsubset_right(mgr[end].left, mgr[end])
#     @test !varsubset_right(mgr[end].left.right, mgr[end])
#     @test !varsubset_right(mgr[end].left.left, mgr[end])
#     @test !varsubset_right(mgr[end], mgr[end])
#     @test !varsubset_right(mgr[end], mgr[end].left)
#     @test !varsubset_right(mgr[end], mgr[end].right)
