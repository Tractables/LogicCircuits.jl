...
using .Juice
import .Juice.IO: 
   parse_comment_line, parse_lc_header_line, parse_literal_line, parse_lc_decision_line, parse_bias_line, 
   CircuitFormatLine, BiasLine, DecisionLine, WeightedLiteralLine, HeaderLine, CommentLine, LCElement
...
@testset "Logistic circuit file parser tests" begin
   ...
   @test parse_comment_line("c    blah blablah") isa CommentLine
   @test parse_lc_header_line("Logisitic Circuit") isa HeaderLine
   @test parse_lc_header_line("Logistic Circuit") isa HeaderLine
   @test parse_literal_line("T 0 0 1 0.11139313932426485 0.5341755009918099 0.4104354811044485 0.2088029562981886 0.38317256253159404 0.21456111303752262 0.33798418436324884 0.7382343563376387 0.5769125897294547 0.13071237914862724") isa WeightedLiteralLine
   @test parse_literal_line("F 1069 490 491 0.6277380017061743 -0.45260459349249044 0.34609986139917703 0.6004763090354547 0.2394524067773312 0.22081649811500942 -0.26666977618500204 0.14544044474614298 0.30372580539872435 0.2192352511676825") isa WeightedLiteralLine
