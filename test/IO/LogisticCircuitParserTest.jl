...
@testset "Logistic circuit file parser tests" begin
   ...
   @test parse_lc_file("circuits/mnist-large.circuit") isa CircuitFormatLines
end

@testset "Test logical circuit loading" begin
   circuit = load_logical_circuit("circuits/mnist-large.circuit")
   ...
   circuit = load_smooth_logical_circuit("circuits/mnist-large.circuit")
   @test circuit isa LogicalΔ
   @test is_decomposable(circuit)

   circuit, vtree = load_struct_smooth_logical_circuit("circuits/mnist-large.circuit", "circuits/balanced.vtree")
